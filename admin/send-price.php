...
$price = $_POST['price'];
$attachedFile = $_FILES["attachment"];
$comment = mysqli_real_escape_string($conn, $_POST['comment']);

$sqlUpdate = 'UPDATE jobs SET price = ' . $price . ', terms_of_payment = ' . $terms_of_payment . ', comment = "' . $comment . '", status = 6 WHERE id = ' . $id;
...
$comfirm_url = $base_url . 'confirm-model.php?id=' . $id;
                    ...
                    <tr>
                        <td>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' style='margin-top: 100px;'>
                                <tr>
                                    <td align='left'>
                                        <span style='font-size: 96px;font-weight: bold;color: #19191a;line-height: 115px;margin-left:90px;'>Approve</span><br/>
                                        <span style='font-size: 96px;font-weight: bold;color: #19191a;line-height: 115px;margin-left:90px;'>project.</span><br/>
                                    </td>
                                </tr>
                            </table>

                            <table width='100%' border='0' cellspacing='0' cellpadding='0' style='margin-top: 45px; margin-bottom: 60px;'>
                                <tbody>
                                    <tr>
                                        ...
                                        -webkit-box-shadow: 0 0 10px 0px #ccc;'>
                                                See attachment for details & click to approve project.<br/><br/>" . "Terms of payment:" . $terms_of_payment . "<br/>" . "Price:" . $price . "$<br/>" . "Comment: " . $comment . "</td>
                                        <td style='width: 100px;'></td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' style='margin-top: 45px;'>
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href='" . $comfirm_url . "' style = 'color: #222;
                                                padding: 5px 50px;
                                                border: 1px solid #222;
                                                border-radius: 30px;
                                                font-size: 40px;
...
sendMail('TEAM@holb.co', 'Administrator of HOLB', $username, $username, 'Price quote from Holb is waiting for you', $content, $attachedFile);
