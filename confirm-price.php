...
$sqlUpdate = 'UPDATE jobs SET status = 7 WHERE id = ' . $id;
...
<body>
    ...
    <div class="flex-column div-process">
        <div class="dash-content">
            <h1 class="huge">Thanks. Let's get to work.</h1>
        </div>
                    ...
                    <tr>
                        <td>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='0' style='margin-top: 100px;'>
                                <tr>
                                    <td align='left'>
                                        <span style='font-size: 96px;font-weight: bold;color: #19191a;line-height: 115px;margin-left:90px;'>Starting</span><br/>
                                        <span style='font-size: 96px;font-weight: bold;color: #19191a;line-height: 115px;margin-left:90px;'>soon</span><br/>
                                    </td>
                                </tr>
                            </table>
...
sendMail('info@holb.com', 'House of Lookbook', 'admin@holb.co', 'admin@holb.co', 'Confirmation of price quote from client', $content);
